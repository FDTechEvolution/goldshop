    ...
    <div class="col-sm-8 col-xs-12">
        <div class="card m-b-20 card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-3">
                    <button type="button" id="bt_order" class="btn btn-lg btn-block waves-effect waves-light btn-outline-secondary m-b-5" data-toggle="modal" data-target="#order" data-name=""> <i class="mdi mdi-clipboard"></i> ใบสั่งซื้อ </button>
                </div>
            </div>
