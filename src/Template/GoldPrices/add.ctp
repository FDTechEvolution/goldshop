<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            ...
            <h3 class="m-t-0 gold-title">เพิ่มราคาประจำวันที่ <?= h($todayDate->i18nFormat(DATE_FORMATE, null, TH_DATE)) ?></h3>
            ...
            <?php $count = 0; ?>
            <?php foreach ($allGoldPrices as $item) : ?>
                <div class="row">
                    <div class="form-group col-md-3 col-sm-4 col-4">
                    ...
                    <div class="form-group col-md-3 col-sm-4 col-4">
                        <?= $this->Form->control('price[' . $count . '].sales_price', ['value' => $item['sales'], 'class' => 'form-control', 'label' => false]) ?>
                    </div>
                    <div class="form-group col-md-3 col-sm-4 col-4">
                        <?= $this->Form->control('price[' . $count . '].purchase_price', ['value' => $item['purchase'], 'class' => 'form-control', 'label' => false]) ?>
                    </div>
                </div>
                <?php $count++; ?>
            <?php endforeach; ?>
