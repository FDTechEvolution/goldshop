        ...
        <div class="card m-b-20 card-body">
            <div class="row">
                <div class="col-6 bt-tool">
                    <?= $this->Html->link(BT_BACK, ['controller' => 'bpartners', $bpartner->iscustomer], ['escape' => false]) ?> 
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="checkbox checkbox-success">
                        <input id="iscompany" type="checkbox" name="iscompany" value="Y" <?= $bpartner->iscompany == 'Y' ? 'checked' : '' ?>>
                        <label for="iscompany">
