...
<div class="col-md-12">
    ...
    <button type="button" class="btn btn-light form-group" data-toggle="modal" data-target="#save_customer_modal" data-name="customer_type" value="save" id="add_bp_bt">เพิ่มข้อมูลลูกค้า</button>
    ...
    <?= $this->Form->hidden('customer_type', ['value' => 'save', 'id' => 'customer_type']) ?>
