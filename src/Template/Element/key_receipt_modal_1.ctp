            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <?php
                        $secondary = 'btn btn-outline-dark waves-effect waves-light btn-block btn-lg m-b-10';
                        $data_name = 'receipt_key';
                        ?>
                        <div class="row m-b-10">
                            <div class="col-md-10 offset-md-1">
                                <div class="row">
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="7">7</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="8">8</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="9">9</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="btn btn-primary waves-effect btn-block btn-lg m-b-10" id="del_bt">DEL</button></div>

                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="4">4</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="5">5</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="6">6</button></div>
                                    <div class="col-md-3" style="padding:5px; "></div>


                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="1">1</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="2">2</button></div>
                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="3">3</button></div>


                                    <div class="col-md-6" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value="0">0</button></div>

                                    <div class="col-md-3" style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name ?>" value=".">.</button></div>
                                    <div class="col-md-3" style="padding:5px; "></div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                <div class="row m-b-10">
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="7">7</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="8">8</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="9">9</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="btn btn-primary waves-effect btn-block btn-lg m-b-10" id="discount_del_bt">DEL</button></div>

                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="4">4</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="5">5</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="6">6</button></div>
                    <div class="col-md-3"  style="padding:5px; "></div>


                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="1">1</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="2">2</button></div>
                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="3">3</button></div>


                    <div class="col-md-6"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value="0">0</button></div>

                    <div class="col-md-3"  style="padding:5px; "><button type="button" class="<?= $secondary ?>" data-name="<?= $data_name_discount ?>" value=".">.</button></div>
