                ...
                <div class="col-md-7">
                    <div class="row">
                        <div class="col-md-6 text-right">
                            <h4 class="prompt-400" id="totalamt_title_label">รวมราคา</h4>  
                    ...
                    <div class="row" id="receipt_box">
                        <div class="col-md-6 text-right">
                            <h4 class="text-success prompt-400" id="">รับเงินมัดจำ</h4>
                        ...
                        <div class="col-md-6 text-right">
                            <h3 id="changeamt_title_label" class=" prompt-400">เงินทอน</h3>

                        </div>
                        <div class="col-md-6 text-right">
                            <h3 id="changeamt_label" class=" prompt-400">0</h3>
                        </div>
                        <div class="col-md-12">
