        ...
        <div class="card-box table-responsive">
            ...
            <div class="row">
                <div class="col-md-3 form-group">
                    ...
                    <?= $this->Form->select('type', $types, ['class' => 'form-control', 'id' => 'type', 'label' => false,'disabled'=>'disabled']) ?>
                </div>
                <div class="col-md-3 form-group">
                ...
                <div class="col-md-3 form-group" id="account_type_box">
                    <label for="account_type">ประเภทบัญชี</label>
                    <?= $this->Form->select('account_type', $bankAccountTypes, ['class' => 'form-control', 'id' => 'account_type', 'label' => false]) ?>
                </div>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <?= $this->Form->control('total_balance', ['class' => 'form-control', 'id' => 'total_balance', 'label' => false,'disabled'=>'disabled']) ?>
                </div>
