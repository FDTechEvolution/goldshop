<style type="text/css">
    ...
    #my_camera { background: #ccc; width: 100%;
                 height: auto; }
    </style>

    <div class="row">
    <div class="col-12">
        <h3>WebcamJS Constraints Test Page</h3>

    </div>
    <div class="col-6 text-center" id="box-cam">
        <div id="my_camera" class="w-100"></div>
        <form>
            <button type="button" id="bt-snapshot" class="btn btn-primary" onClick="take_snapshot()">จับภาพ</button>
        </form>
    </div>
...
<script language="JavaScript">
    function take_snapshot() {
        ...
        Webcam.snap(function (data_uri) {
            ...
            document.getElementById('results').innerHTML =
                    '' +
                    '<img src="' + data_uri + '" class="w-100" id="img-snap"/> <button type="button" id="bt-process" class="btn btn-primary mt-md-2" onClick="">วิเคราะห์</button>';
        });
        shutterPlay();
    }
    ...
    $(document).ready(function () {
        ...
        Webcam.set({
            ...
            jpeg_quality: 100,
            constraints: {
                width: width, // { exact: 320 },
                height: (width / 1.78), // { exact: 180 },
                facingMode: 'user',
                frameRate: 30
            }
        });
