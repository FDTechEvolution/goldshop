...
/***********BUTTON*********/
define('TB_BT_EDIT','<button type="button" class="btn btn-icon waves-effect waves-light btn-secondary m-b-5"> <i class="fa fa-pencil"></i> </button>');
...
define('BT_EDIT', '<button class="btn btn-sm"><span class=" ti-marker-alt"></span></button>');
define('BT_VIEW', '<button class="btn btn-sm btn-sm"><span class="fa fa-eye"></span></button>');
define('BT_DELETE', '<button type="button" class="btn btn-sm"><i class="ti-trash"></i></button>');
